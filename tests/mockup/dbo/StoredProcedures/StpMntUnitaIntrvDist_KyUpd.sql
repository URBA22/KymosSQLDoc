...
-- ==========================================================================================
-- Entity Name:	StpMntUnitaIntrvDist_KyUpd
-- Create date:	21/03/2018 16:33:19
-- AutoCreate:	YES
-- Custom:	NO
-- Generator:	01.00.01
-- CustomNote:	Write custom note here
-- Description:	This stored procedure is intended for updating TbMntUnitaIntrvDist table
-- History:
-- fab 15.04.19	Aggiunto Tavola, TavolaPosiz e cambiato IdIntrv da int a nvarchar
-- ==========================================================================================
CREATE Procedure [dbo].[StpMntUnitaIntrvDist_KyUpd]
(
	@IdIntrvDist int,
	@IdIntrv nvarchar(20),
	...
	BEGIN
		BEGIN TRY
			BEGIN TRANSACTION
				...
				Update TbMntUnitaIntrvDist
				Set
					[IdIntrv] = @IdIntrv,
					[IdArticolo] = @IdArticolo,
					[Descrizione] = @Descrizione,
					[UnitM] = @UnitM,
					[UnitMCoeff] = @UnitMCoeff,
					[Qta] = @Qta,
					[CostoUnit] = @CostoUnit,
					[Tavola] = @Tavola,
					[TavolaPosiz] = @TavolaPosiz,
