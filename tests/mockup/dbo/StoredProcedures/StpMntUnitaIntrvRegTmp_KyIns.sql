...
-- ==========================================================================================
-- Entity Name:	StpMntUnitaIntrvRegTmp_KyIns
-- Create date:	18/01/2019 18:23:20
-- AutoCreate:	YES
-- Custom:	NO
-- Generator:	01.00.01
-- CustomNote:	Write custom note here
-- Description:	This stored procedure is intended for inserting values to TbMntUnitaIntrvRegTmp table
--
-- ==========================================================================================
CREATE Procedure StpMntUnitaIntrvRegTmp_KyIns
(
	@IdIntrvRegTmp int OUTPUT,
	@IdIntrv nvarchar(20),
	...
	BEGIN
		BEGIN TRY
			BEGIN TRANSACTION
				...
				Insert Into TbMntUnitaIntrvRegTmp
					([IdIntrv],[IdUtente],[DataReg],[DataInizio],[DataFine],[Durata],[IdTipoAtvt],[NoteRegTmp],[SysUserCreate],[SysDateCreate])
				Values
					(@IdIntrv,@IdUtente,@DataReg,@DataInizio,@DataFine,@Durata,@IdTipoAtvt,@NoteRegTmp,@SysUserCreate,Getdate())

				Select @IdIntrvRegTmp = SCOPE_IDENTITY() 
