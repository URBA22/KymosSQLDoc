...
-- ==========================================================================================
-- Entity Name:	StpMatrStato_KyDel
-- Create date:	15/02/2019 16:56:00
-- AutoCreate:	YES
-- Custom:	NO
-- Generator:	01.00.01
-- CustomNote:	Write custom note here
-- Description:	This stored procedure is intended for deleting a specific row from TbMatrStato table
--
-- ==========================================================================================
CREATE Procedure StpMatrStato_KyDel
(
	@IdMatrMov int,
...
Begin
	...
	****************************************************************/
	...
	BEGIN
		...
		****************************************************************/
		/*
		If Exists(SELECT IdMatrMov  FROM TbMatrStato WHERE (IdMatrMov = @IdMatrMov))
		BEGIN
		...
		BEGIN TRY
			BEGIN TRANSACTION
				...
				BEGIN
					...
					EXECUTE StpGen_DelDoc 'TbMatrStato', @IdMatrMov
