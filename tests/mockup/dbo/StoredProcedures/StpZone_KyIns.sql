...
-- Description: This stored procedure is intended for inserting values to TbZone table
-- History:
-- dav 221127 Creazione
-- =============================================
CREATE PROCEDURE [dbo].[StpZone_KyIns]
(
	@IdZona NVARCHAR(20) OUTPUT,
	@DescZona NVARCHAR(200),
	@Disabilita BIT,
	...
	BEGIN
		BEGIN TRY
			BEGIN TRANSACTION
				...
				INSERT INTO TbZone
					([IdZona],[DescZona],[Disabilita],[SysUserCreate],[SysDateCreate])
				VALUES
					(@IdZona,@DescZona,@Disabilita,@SysUserCreate,GETDATE())
