-- =============================================
-- Entity name: StpMntAnagDpi_KyDel
-- Author:		auto
-- Create date: 230127
-- AutoCreate: YES
-- Custom: NO
...
-- Description: This stored procedure is intended for deleting a specific row from  TbMntAnagDpi table
-- History:
-- dav 230127 Creazione
-- =============================================
CREATE PROCEDURE [dbo].[StpMntAnagDpi_KyDel]
(
	@IdDpi NVARCHAR(20),
...
BEGIN
	...
	****************************************************************/
	...
	BEGIN
		...
		****************************************************************/
		/*
		IF EXISTS(SELECT IdDpi FROM #TableName WHERE (IdDpi = @IdDpi))
		BEGIN
			...
			BEGIN TRANSACTION
				...
				BEGIN
					...
					****************************************************************/
					...
					EXECUTE StpGen_DelDoc 'TbMntAnagDpi', @IdDpi
