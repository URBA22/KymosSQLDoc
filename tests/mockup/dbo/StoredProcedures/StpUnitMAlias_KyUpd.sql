-- =============================================
-- Entity name: StpUnitMAlias_KyUpd
-- Author:		Auto
-- Create date: 221203
-- AutoCreate: YES
-- Custom_Dbo: NO
...
-- Description: This stored procedure is intended for updating TbUnitMAlias table
-- History:
-- dav 221203 Creazione
-- =============================================
CREATE PROCEDURE [dbo].[StpUnitMAlias_KyUpd]
(
	@IdUnitMAlias INT,
	@UnitM NVARCHAR(20),
