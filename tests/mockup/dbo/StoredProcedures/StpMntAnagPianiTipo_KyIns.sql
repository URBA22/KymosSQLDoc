-- =============================================
-- Entity name: StpMntAnagPianiTipo_KyIns
-- Author:		Auto
-- Create date: 26-01-23
-- AutoCreate: YES
-- Custom_Dbo: NO
-- Generator: 26-01-23
-- CustomNote:  Write custom note here
-- Description: This stored procedure is intended for inserting values to TbMntAnagPianiTipo table
-- History:
-- dav 230126 Creazione
-- =============================================
CREATE PROCEDURE [dbo].[StpMntAnagPianiTipo_KyIns]
(
	@IdPianoTipo NVARCHAR(20) OUTPUT,
	...
	BEGIN
		BEGIN TRY
			BEGIN TRANSACTION
				...
				INSERT INTO TbMntAnagPianiTipo
					([IdPianoTipo],[DescTipo],[Disabilita],[SysUserCreate],[SysDateCreate])
				VALUES
					(@IdPianoTipo,@DescTipo,@Disabilita,@SysUserCreate,GETDATE())
