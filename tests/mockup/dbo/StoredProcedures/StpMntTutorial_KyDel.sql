...
-- ==========================================================================================
-- Entity Name:	StpMntTutorial_KyDel
...
-- Description:	This stored procedure is intended for deleting a specific row from TbMntTutorial table
-- ==========================================================================================
Create Procedure StpMntTutorial_KyDel
(
...
Begin
	...
	****************************************************************/
	...
	BEGIN
		...
		****************************************************************/
		/*
		If Exists(SELECT IdTutorial  FROM TbMntTutorial WHERE (IdTutorial = @IdTutorial))
		BEGIN
		...
		BEGIN TRY
			BEGIN TRANSACTION
				...
				BEGIN
					...
					EXECUTE StpGen_DelDoc 'TbMntTutorial', @IdTutorial
