...
-- ==========================================================================================
-- Entity Name:	StpMntObjTutorial_KyIns
...
-- Description:	This stored procedure is intended for inserting values to TbMntObjTutorial table
-- ==========================================================================================
Create Procedure StpMntObjTutorial_KyIns
(
	@IdObjTutorial int OUTPUT,
		...
		BEGIN TRY
			BEGIN TRANSACTION
				...
				Insert Into TbMntObjTutorial
					([IdObject],[IdTutorial],[RifTutorial],[SysUserCreate],[SysDateCreate])
				Values
					(@IdObject,@IdTutorial,@RifTutorial,@SysUserCreate,Getdate())

				Select @IdObjTutorial = SCOPE_IDENTITY() 
