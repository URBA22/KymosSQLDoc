...
-- ==========================================================================================
-- Entity Name:	StpMntManutentori_KyDel
-- Create date:	07/02/2018 15:39:20
-- AutoCreate:	YES
-- Custom:	NO
-- Generator:	01.00.01
-- CustomNote:	Write custom note here
-- Description:	This stored procedure is intended for deleting a specific row from TbMntManutentori table
-- ==========================================================================================
CREATE Procedure StpMntManutentori_KyDel
(
	@IdManutentore int,
		...
		BEGIN TRY
			BEGIN TRANSACTION
				...
				BEGIN
					...
					EXECUTE StpGen_DelDoc 'TbMntManutentori', @IdManutentore
